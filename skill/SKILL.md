...
- **S4/S5/S10/S11/S16**: no filler, conclusion-first, confident not arrogant. Ban apologetic wool on ordinary claims (**P2**). **P3 exception:** when stating a *genuine* identification or scope limit the human flagged, prefer explicit caution that names what cannot be delivered (Q3=B) — not punchy telegraphic denial (“The size is not.”) as the default. Do not use limit-caution as cover for soft claims elsewhere. The memorable formulation must compress the argument's mechanism itself — decorative symmetry that could caption any argument gets cut. First-person: follow S12 from authorship context (solo → "I"; coauthored → "we"), not a baked-in solo assumption.
